...
public class bubble extends JFrame implements ActionListener {
	...
	private JScrollPane jsp2 = new JScrollPane(jta2, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
			JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
	private JButton jbt1 = new JButton("오름차순 정렬");
	...
	public bubble() {
		...
		jl1.setFont(new Font("맑은고딕", Font.BOLD, 18));
		jl2.setFont(new Font("맑은고딕", Font.BOLD, 18));
		jta1.setFont(new Font("맑은고딕", Font.BOLD, 15));
		jta2.setFont(new Font("맑은고딕", Font.BOLD, 15));
	...
	public void actionPerformed(ActionEvent arg0) {
		// TODO Auto-generated method stub
		if (arg0.getActionCommand() == "오름차순 정렬") {
			jta1.setText("");
		...
		} else if (arg0.getActionCommand() == "내림차순 정렬") {
			jta1.setText("");
			String get = jta2.getText();
			String[] get1 = get.split(",");
